    ...
    },
    {
      ...
      items: [
        ...
        { label: "Report an Issue", to: soon, icon: <IconAlert className={itemIcon} /> },
        {
          ...
          to: soon,
          icon: <Pin className="h-[22px] w-auto shrink-0" decorative />,
        },
      ],
    },
    {
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/45">
      ...
      <div className="pointer-events-none absolute inset-0 flex items-center justify-end p-2 sm:p-4">
        {/* Outer chrome frame */}
        <div
          className="cp-glass cp-glass-thick pointer-events-auto max-h-full w-[calc(100%-2.5rem)] max-w-[420px] p-2.5 sm:max-w-[460px] sm:p-3"
        ...
        >
          ...
          >
            ...
            <div className="flex items-start gap-3">
              <Pin className="h-12 w-auto shrink-0" decorative />
