      ...
      <div className="flex items-start justify-between gap-2">
        ...
        {tier.is_top10 && (
          <span
            className={
              dark
                ? "cp-btn-pop whitespace-nowrap px-3 py-1 text-xs font-bold text-slate-100"
          ...
          {paymentLink ? (
            <div className="flex flex-col gap-2 sm:flex-row">
              <a
                ...
                className={
                  dark
                    ? "cp-btn-pop cp-press flex-1 px-4 py-2.5 text-center text-sm font-bold text-slate-100"
