var C={
  ...
  hotel:{l:"Hotels",i:"&#127976;",c:"#0f766e"},
  other:{l:"&#10024; Other",i:"&#10024;",c:"#6b7280"}
};
var ORD=["seasonal","workshop","market","foodhall","bars","cityart","parks","venue","centers","museum","hotel","shop","homecook","other"];
...
function mkTCard(ev,featured){
  ...
  var tcLive=flyerLiveStatus(ev);
  body.innerHTML=(featured?"<span class='tcpin'>&#9733; Featured</span>":"")+
    "<span class='livebadge "+tcLive.cls+"'>"+tcLive.emoji+" "+tcLive.label+"</span>"+
